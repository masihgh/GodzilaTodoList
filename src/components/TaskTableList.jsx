...
import { removeTask, completeTask } from '../features/home/TasksSlice';
import { DeleteTask, CompleteTaskUp } from "../api/TaskAPI";
                                                    ...
                                                    <div className="task" key={index}>
                                                        <div className="task-body">
                                                            ...
                                                            <div className="card-actions mt-3">
                                                                <button onClick={() => handleCompleteTask(task)} className={`btn btn-sm btn-${(task.isDone) ? 'success' : 'primary'}`}>{(task.isDone) ? 'Completed' : 'Complete'}</button>
